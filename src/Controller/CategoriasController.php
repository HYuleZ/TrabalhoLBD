...
class CategoriasController extends AppController
{
    ...
    public function add()
    {
        ...
        $livros = $this->Categorias->Livros->find('list', ['limit' => 200])->all();
        $menus = $this->Categorias->Menus->find('list', ['limit' => 200])->all();
        $usuarios = $this->Categorias->Usuarios->find('list', ['limit' => 200])->all();
        $this->set(compact('categoria', 'livros', 'menus', 'usuarios'));
    }
